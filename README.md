...
```bash
git clone https://github.com/tetrashop/tetrashop-quantum.git
cd tetrashop-quantum
# دستورات نصب
```
...
- **URL:** [  🚀 دیپلوی tetrashop-quantum روی Vercel...
    ❌ دیپلوی ناموفق!
...
Vercel CLI 58.5.1 (Node.js 26.4.0)
  ...
  Directory       ~/github/tetrashop-quantum
...
✓ Created         ramin-edjlal-s-projects/tetrashop-quantum

> Connecting GitHub repository: https://github.com/tetrashop/tetrashop-quantum
> Connected
Deploying ramin-edjlal-s-projects/tetrashop-quantum
Uploading [--------------------] (0.0B/3.8KB)
Uploading [====================] (3.8KB/3.8KB)
Error: Resource is limited - try again in 24 hours (more than 100, code: "api-deployments-free-per-day").](  🚀 دیپلوی tetrashop-quantum روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
